          ...
          <div className="relative flex flex-col gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8 pb-16">
              <Link href="/auth/login">
                <Button 
                  size="lg" 
                  className="group relative overflow-hidden bg-white/80 backdrop-blur-sm border-2 border-blue-200/60 text-blue-700 hover:text-blue-800 hover:bg-white/90 hover:border-blue-300/80 transition-all duration-300 ease-out shadow-lg hover:shadow-xl min-w-[160px] h-14 text-lg font-semibold rounded-2xl"
                >
              ...
              <Link href="/auth/register">
                <Button 
                  size="lg" 
                  className="group relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white hover:from-blue-700 hover:via-blue-800 hover:to-blue-900 transition-all duration-300 ease-out shadow-lg hover:shadow-2xl hover:shadow-blue-500/25 min-w-[160px] h-14 text-lg font-semibold rounded-2xl border-0"
                >
