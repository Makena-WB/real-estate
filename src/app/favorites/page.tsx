...
export default async function FavoritesPage() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <h2 className="text-3xl font-bold text-blue-800 mb-4">Access Required</h2>
          <p className="text-blue-600 text-lg mb-8">Please log in to view your favorite properties</p>
          <Link href="/auth/login">
            <button className="px-8 py-4 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white font-semibold rounded-2xl hover:from-blue-700 hover:to-blue-900 transition-all duration-300 shadow-lg hover:shadow-xl">
              Sign In
            </button>
          </Link>
        </div>
  ...
  const favorites: FavoriteWithListing[] = await prisma.favorite.findMany({
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">My Favorite Properties</h1>
      ...
      <div className="max-w-7xl mx-auto py-16 px-6">
        {favorites.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-bold text-blue-800 mb-4">No Favorites Yet</h3>
            <p className="text-blue-600 text-lg mb-8 max-w-md mx-auto">
            ...
            {favorites.map((fav) => (
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  {fav.listing.images && fav.listing.images.length > 0 ? (
                    <div className="relative">
                      <img
                        src={
                          Array.isArray(fav.listing.images) ? fav.listing.images[0] : fav.listing.images.split(",")[0]
                        }
                      ...
                      <div className="absolute bottom-4 left-4">
                        <div className="bg-white/95 backdrop-blur-sm px-4 py-2 rounded-2xl shadow-lg">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-blue-800 text-lg">{formatPrice(fav.listing.price)}</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="w-full h-64 bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center relative">
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Date Added */}
                  <div className="text-xs text-blue-500 bg-blue-50/50 px-3 py-2 rounded-xl">
                ...
                <CardFooter className="pt-4 border-t border-blue-100/50">
                  <div className="flex items-center justify-between w-full">
                    ...
                    <div className="flex gap-2">
                      <button className="px-3 py-2 bg-red-50 text-red-600 text-sm font-semibold rounded-xl hover:bg-red-100 transition-all duration-200 border border-red-200">
                        Remove
                      </button>
